...
<header>
  <nav id="myDiv">
    ...
    <ul class="navbar-links">
      <li><a class="btn1 <?php if($active == 'Acasa') echo"active"; ?>" id="acasa" href="index.php">Acasa</a></li>
      <li><a class="btn1 <?php if($active == 'Despre Noi') echo"active"; ?>" id="despre" href="despre_noi.php">Despre noi</a></li>
      <li><a class="btn1 <?php if($active == 'Contact') echo"active"; ?>" id="contact" href="contact.php">Contact</a></li>
      <li><a class="btn1 <?php if($active == 'Conditii Generale') echo"active"; ?>" id="conditii" href="conditii_generale.php">Conditii generale</a></li>
      <li><a class="btn1 <?php if($active == 'Certificari') echo"active"; ?>" id="certificari" href="certificari.php">Certificari</a></li>
      <li><a class="btn1 <?php if($active == 'Calendar') echo"active"; ?>" id="calendar" href="calendar.php">Calendar</a></li>
    </ul>
  </nav>
</header>